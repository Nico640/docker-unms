FROM --platform=linux/amd64 ubnt/unms:1.4.5 as unms
FROM --platform=linux/amd64 ubnt/unms-nginx:1.4.5 as unms-nginx
FROM --platform=linux/amd64 ubnt/unms-netflow:1.4.5 as unms-netflow
FROM --platform=linux/amd64 ubnt/unms-crm:3.4.5 as unms-crm
FROM --platform=linux/amd64 ubnt/unms-siridb:1.4.5 as unms-siridb
FROM --platform=linux/amd64 ubnt/unms-postgres:1.4.5 as unms-postgres
